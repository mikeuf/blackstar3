...
function ValidateForm()
{
  ...
  var Birthdate = document.forms["form1"]["Birthdate"].value;
  if (!ValidateNotBlank(Birthdate, "date of birth" ))  return false;
...
function ValidateLastFourLength(val)
{
  ...
  {
    alert("The four-digit zip code extension must be either 4 digits or omitted entirely.");
    return false;
  }
  return true;
}
